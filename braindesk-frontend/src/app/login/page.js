...
export default function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Something went wrong! Check backend.",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="w-full md:w-5/12 bg-hover p-10 flex flex-col justify-between relative overflow-hidden border-r border-border">
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold mb-6 text-balance leading-tight">
              Your ultimate <br />
              <span className="text-accent">AI Workspace.</span>
            </h2>

            <p className="text-muted mb-8 leading-relaxed text-sm">
              Log in to access your dual-layer memory, universal RAG pipeline,
              and autonomous testing agents. Everything syncs perfectly.
            </p>
            ...
            <div className="bg-card border border-accent/30 rounded-2xl p-5 shadow-lg relative overflow-hidden group">
              ...
              <p className="text-sm text-muted leading-relaxed relative z-10 mb-4">
                ...
                <strong>inside the workspace</strong> to let BrainDesk instantly
                read, modify, and push code files to your repositories
              ...
              <div className="flex flex-col gap-2 relative z-10">
                ...
                <div className="flex items-center gap-2 text-xs font-semibold text-foreground">
                  <Zap className="w-3.5 h-3.5 text-amber-500" /> Auto-Commit
                  Generation
                </div>
              </div>
            </div>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <p className="text-muted text-sm mb-8">
              {isLogin
                ...
                : "Join developers automating their workflow today."}
            </p>
            ...
            <div className="flex items-center my-6">
              ...
              <span className="px-4 text-muted text-xs uppercase tracking-widest font-semibold">
            ...
            {error && (
              <motion.div
                ...
                className="bg-red-500/10 border border-red-500/30 text-red-500 p-3 rounded-xl mb-6 text-sm flex items-center gap-2"
              >
